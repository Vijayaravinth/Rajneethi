...
public class VoterListV extends Util implements View.OnClickListener {
    ...
    private void fetchPartyWorkerFromServer() {
        ...
        try {
            ...
            JsonArrayRequest jsObjRequest = new JsonArrayRequest(Request.Method.GET,
                    API.GETROLEURL+"VOTERS&SupervisorId="+getIntent().getStringExtra("SUPRVISOR_ID")+"&PartyWorkerId="+getIntent().getStringExtra("PARTY_WORKER_ID")+"&BoothId="+getIntent().getStringExtra("BOOTHNAME"),
                    null,
                    new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray  response) {
                            ...
                            if (voterlists.size() > 0) {

                                final VoterListAdapteroff adapter = new VoterListAdapteroff(VoterListV.this,voterlists,getIntent().getStringExtra("BOOTHNAME"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                // new delete().execute();
                startActivity(new Intent(VoterListV.this, LoginActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                VoterListV.this.finish();
                return true;
        }
    ...
    public void onClick(View v) {
        //startActivity(new Intent(VoterListV.this, PartyWorkers.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK));
        Intent intent = new Intent(this,BoothList.class);
        intent.putExtra("PARTY_WORKER_ID", String.valueOf(getIntent().getStringExtra("PARTY_WORKER_ID")));
        intent.putExtra("SUPRVISOR_ID",  String.valueOf(getIntent().getStringExtra("SUPRVISOR_ID")));
